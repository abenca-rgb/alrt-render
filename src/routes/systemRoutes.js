export function registerSystemRoutes(app, {
  ...
  app.get("/health", (req, res) => {
    ...
    res.status(200).json({
      ...
      shadowV21LiveGateEnabled: Boolean(config.shadowV21LiveGateEnabled),
      shadowV21LiveGateMode: config.shadowV21LiveGateMode,
      shadowV21CandidateLogging: Boolean(config.shadowV21CandidateLogging),
